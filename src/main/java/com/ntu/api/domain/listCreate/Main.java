...
public class Main {
    ...
    public static void start(){
        ...
        bituminous.add(new Bituminous("АЩМ1","Щільний асфальтобето-полімербетон","БМПА 60/90-53 на основі термопластів",7000.0,0.09,14.0,0.1,7.0,3.1,1.0,0.9,elasticModulsAshm1,staticModulsAshC1,4.0,6.0,2186.73));
        bituminous.add(new Bituminous("АЩМ2","Щільний асфальтобето-полімербетон","БМПА 60/90-53 на основі термоеластопластів",5500.0,0.09,12.0,0.1,6.5,2.9,1.0,0.9,elasticModulsAshm2,staticModulsAshC1,4.0,6.0,2186.73));
        bituminous.add(new Bituminous("АЩ1","Щільний асфальтобетобетон І-ІІ марки","БНД 40/60",6000.0,0.09,10.0,0.1,6.0,3.7,0.9,0.8,elasticModulsAsh1,staticModulsAshC2,5.0,10.0,1840.61));
        bituminous.add(new Bituminous("АЩ2","Щільний асфальтобетобетон І-ІІ марки","БНД 60/90",4500.0,0.1,9.8,0.1,5.5,4.0,0.9,0.8,elasticModulsAsh2,staticModulsAshC2,5.0,10.0,1841.61));
        bituminous.add(new Bituminous("АЩ3","Щільний асфальтобетобетон І-ІІ марки","БНД 90/130",3600.0,0.1,9.5,0.1,5.0,4.5,0.9,0.8,elasticModulsAsh3,staticModulsAshC2,5.0,10.0,1842.61));
        bituminous.add(new Bituminous("АЩ4","Щільний асфальтобетобетон І-ІІ марки","БНД 130/200",2600.0,0.11,9.3,0.12,4.5,5.1,0.9,0.8,elasticModulsAsh4,staticModulsAshC2,5.0,10.0,1843.61));
        bituminous.add(new Bituminous("АП1","Пористий асфальтобетобетон","БНД 40/60",3600.0,0.1,8.3,0.12,4.5,7.2,0.75,0.8,elasticModulsAp1,staticModulsApC1,8.0,12.0,1829.02));
        bituminous.add(new Bituminous("АП2","Пористий асфальтобетобетон","БНД 60/90",2800.0,0.11,8.0,0.12,4.3,8.2,0.75,0.8,elasticModulsAp2,staticModulsApC4,8.0,12.0,1830.02));
        bituminous.add(new Bituminous("АП3","Пористий асфальтобетобетон","БНД 90/130",2200.0,0.12,7.8,0.14,4.0,8.6,0.75,0.8,elasticModulsAp3,staticModulsApC3,8.0,12.0,1831.02));
        bituminous.add(new Bituminous("АП4","Пористий асфальтобетобетон","БНД 130/200",1800.0,0.1,7.6,0.1,3.75,9.0,0.75,0.8,elasticModulsAp4,staticModulsApC2,8.0,12.0,1832.02));
        bituminous.add(new Bituminous("АВП1","Високо-пористий асфальтобетобетон","БНД 40/60",3000.0,0.11,6.0,0.15,4.3,8.8,0.7,0.75,elasticModulsAvp1,staticModulsApC1,8.0,15.0,1362.59));
        bituminous.add(new Bituminous("АВП2","Високо-пористий асфальтобетобетон","БНД 60/90",2100.0,0.12,5.8,0.15,4.0,9.3,0.7,0.75,elasticModulsAvp2,staticModulsApC4,8.0,15.0,1363.59));
        bituminous.add(new Bituminous("АВП3","Високо-пористий асфальтобетобетон","БНД 90/130",1700.0,0.12,5.5,0.15,3.75,9.8,0.7,0.75,elasticModulsAvp3,staticModulsApC3,8.0,15.0,1364.59));
        bituminous.add(new Bituminous("ЩМА1","Щебеневомастиковий асвальтобетон виду ЩМА-5","БНД 40/60",5000.0,0.11,7.3,0.12,6.0,3.7,0.85,0.85,elasticModulsShma1,staticModulsShmAc1,3.0,5.0,2421.43));
        bituminous.add(new Bituminous("ЩМА2","Щебеневомастиковий асвальтобетон виду ЩМА-5","БНД 60/90",4500.0,0.11,6.6,0.11,5.5,4.0,0.85,0.85,elasticModulsShma2,staticModulsShmAc1,3.0,5.0,2422.43));
        bituminous.add(new Bituminous("ЩМА3","Щебеневомастиковий асвальтобетон виду ЩМА-10","БНД 40/60",4100.0,0.1,4.6,0.12,6.0,3.7,0.85,0.85,elasticModulsShma3,staticModulsShmAc2,3.0,5.0,2423.43));
        bituminous.add(new Bituminous("ЩМА4","Щебеневомастиковий асвальтобетон виду ЩМА-10","БНД 60/90",3900.0,0.12,4.2,0.11,5.5,4.0,0.85,0.85,elasticModulsShma4,staticModulsShmAc2,3.0,5.0,2424.43));
        bituminous.add(new Bituminous("ЩМА5","Щебеневомастиковий асвальтобетон виду ЩМА-15","БНД 40/60",3800.0,0.12,4.2,0.12,6.0,3.7,0.85,0.85,elasticModulsShma5,staticModulsShmAc3,4.5,6.0,2425.43));
        bituminous.add(new Bituminous("ЩМА6","Щебеневомастиковий асвальтобетон виду ЩМА-15","БНД 60/90",3600.0,0.1,3.9,0.13,5.5,4.0,0.85,0.85,elasticModulsShma6,staticModulsShmAc3,4.5,6.0,2426.43));
        bituminous.add(new Bituminous("ЩМА7","Щебеневомастиковий асвальтобетон виду ЩМА-20","БНД 40/60",3500.0,0.12,3.2,0.12,6.0,3.7,0.85,0.85,elasticModulsShma7,staticModulsShmAc4,5.0,7.0,2427.43));
        bituminous.add(new Bituminous("ЩМА8","Щебеневомастиковий асвальтобетон виду ЩМА-20","БНД 60/90",3300.0,0.12,2.9,0.13,5.5,4.0,0.85,0.85,elasticModulsShma8,staticModulsShmAc4,5.0,7.0,2428.43));
        bituminous.add(new Bituminous("ЩМА9","Щебеневомастиковий асвальтобетон виду ЩМА-5","БМПА 60/90-52",5200.0,0.08,7.5,0.1,6.5,2.9,0.85,0.85,elasticModulsShma9,staticModulsShmAc1,3.0,4.0,2429.43));
        bituminous.add(new Bituminous("ЩМА10","Щебеневомастиковий асвальтобетон виду ЩМА-10","БМПА 60/90-52",4500.0,0.08,5.6,0.1,6.5,2.9,0.85,0.85,elasticModulsShma10,staticModulsShmAc2,4.0,5.0,2430.43));
        bituminous.add(new Bituminous("ЩМА11","Щебеневомастиковий асвальтобетон виду ЩМА-15","БМПА 60/90-52",4100.0,0.09,4.3,0.11,6.5,2.9,0.85,0.85,elasticModulsShma11,staticModulsShmAc3,4.5,6.0,2431.43));
        bituminous.add(new Bituminous("ЩМА12","Щебеневомастиковий асвальтобетон виду ЩМА-20","БМПА 60/90-52",3700.0,0.1,3.4,0.13,6.5,2.9,0.85,0.85,elasticModulsShma12,staticModulsShmAc4,5.0,7.0,2432.43));
